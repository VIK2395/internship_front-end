...
var Message = (function (_Component) {
  ...
  Message.prototype.render = function render() {
    const admin = 'Deadpool';

    var infoClassList = [
      'sc-message--info',
      this.props.message.author === 'me' ? 'sent' : 'received',
      this.props.message.author === admin ? 'admin' : '',
    ];
    ...
    // mega costyl
    let avatar = null;
    if (this.props.message.author === admin) {
    ...
    return React.createElement(
      'div',
      { className: 'sc-message--wrapper' },
      React.createElement(
        'div',
        { className: infoClassList.join(' ') },
        React.createElement('div', { className: 'sc-message--author' }, this.props.message.author),
        React.createElement('div', { className: 'sc-message--time' }, this.props.message.time)
      ),
      React.createElement(
        'div',
